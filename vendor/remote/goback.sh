#!/bin/bash
# 随 vps-benchkit 仓库收录（vendored），供菜单「3. 回程路由」使用。
# 上游仓库: https://github.com/V2RaySSR/vps
# 上游文件: https://github.com/V2RaySSR/vps/blob/master/goback.sh
# Raw: https://raw.githubusercontent.com/V2RaySSR/vps/master/goback.sh
